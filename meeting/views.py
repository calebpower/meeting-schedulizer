...
class RegisterProcess(View):
    def post(self, request, *args, **kwargs):
        ...
        display_name = request.POST.get('inputname') if request.POST.get('inputname') else None
        errors = dict()
...
class ProfilePage(View):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'profile_page.html', { 'username': username, 'name': display_name, 'is_no_errors': True, 'get_load': True })
    ...
    def post(self, request, *args, **kwargs):
        ...
        if is_no_errors:
            ...
            username = logged_in_user.username
            display_name = logged_in_user.profile.display_name
        return render(request, 'profile_page.html', {'username': username, 'name': display_name, 'errors': errors, 'is_no_errors': is_no_errors, 'get_load': False })
